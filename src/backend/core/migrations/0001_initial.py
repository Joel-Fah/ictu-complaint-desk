...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('office', models.CharField(choices=[('FINANCE_DEPARTMENT', 'Finance Department'), ('CISCO_LAB', 'Cisco Lab'), ('REGISTRAR_OFFICE', 'Registrar Office'), ('FACULTY', 'Faculty'), ('OTHER', 'Other')], max_length=50)),
