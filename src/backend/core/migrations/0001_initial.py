    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[(core.models.UserRole['STUDENT'], 'Student'), (core.models.UserRole['LECTURER'], 'Lecturer'), (core.models.UserRole['ADMIN'], 'Admin'), (core.models.UserRole['COMPLAINT_COORDINATOR'], 'Complaint Coordinator')], default=core.models.UserRole['STUDENT'], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='core.lecturerprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
