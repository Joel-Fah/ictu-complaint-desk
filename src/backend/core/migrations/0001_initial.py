    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resolved_by', models.ForeignKey(help_text='The staff member who resolved the complaint', limit_choices_to={'role__in': ['Lecturer', 'Admin', 'Complaint Coordinator']}, on_delete=django.db.models.deletion.CASCADE, related_name='resolutions', to=settings.AUTH_USER_MODEL, verbose_name='Resolved by')),
                ('reviewed_by', models.ForeignKey(help_text='The staff member who reviewed the resolution', limit_choices_to={'role__in': ['Admin', 'Complaint Coordinator']}, on_delete=django.db.models.deletion.CASCADE, related_name='reviewed_resolutions', to=settings.AUTH_USER_MODEL, verbose_name='Reviewed by')),
            ],
        ),
        migrations.CreateModel(
            name='StudentProfile',
